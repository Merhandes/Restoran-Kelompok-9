   ...
   <div class="swiper hero-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span>Makanan Japanese</span>
               <h3>Sushi</h3>
               <a href="menu.php" class="btn">Lihat menu</a>
            </div>
            <div class="image">
               <img src="images/sushii.jpeg" alt="">
            </div>
         </div>

         <div class="swiper-slide slide">
            <div class="content">
               <span>Makanan Western</span>
               <h3>Cheese burger</h3>
               <a href="menu.php" class="btn">Lihat menu</a>
            </div>
            <div class="image">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span>Desserts</span>
               <h3>Mille crepes oreo</h3>
               <a href="menu.php" class="btn">Lihat menu</a>
            </div>
            <div class="image">
               <img src="images/mille.jpeg" alt="">
            </div>
         </div>
...
<section class="category">
   ...
   <div class="box-container">
      ...
      <a href="category.php?category=Cepat saji" class="box">
         <img src="images/cat-1.png" alt="">
         <h3>Cepat saji</h3>
      </a>

      <a href="category.php?category=Menu utama" class="box">
      ...
      <a href="category.php?category=Penutup" class="box">
